...
const Landing = () => {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-svh bg-theme-bg overflow-hidden text-gray-200">
      ...
      {/* 메인 콘텐츠 */}
      <div className="relative z-10 flex flex-col items-center max-w-2xl px-8 text-center animate-fade-in-up">

        {/* 로고 마크 (Login.jsx와 동일 SVG, 더 큰 사이즈) */}
        <div className="p-5 bg-[#1a1a1a] rounded-3xl mb-8 border border-[#2a2a2a] shadow-[0_0_40px_rgba(78,201,176,0.2)] flex items-center justify-center">
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#4ec9b0" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* 브랜드명 */}
        <h1 className="text-7xl md:text-8xl font-black tracking-tight text-white mb-6 pb-2">
          Lucid
        </h1>
        ...
        <button
          ...
          className="group relative overflow-hidden flex items-center justify-center gap-3 bg-white text-gray-900 font-semibold py-4 px-10 rounded-xl shadow-lg hover:-translate-y-0.5 hover:shadow-xl hover:shadow-white/10 transition-all duration-300 text-lg"
        >
