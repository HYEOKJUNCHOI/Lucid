...
| 문제 | Lucid의 해결책 |
|------|---------------|
| 학생들의 낮은 학습 동기 | 게임화 (XP, 레벨, 스트릭, 하트 시스템) |
| 강사의 높은 채점/출제 부담 | AI 자동 퀴즈 생성, AI 코드리뷰 |
| 개인별 학습 격차 해소 미흡 | AI 튜터 채팅 (코드 컨텍스트 기반) |
| 학생 학습 상태 파악의 어려움 | 실시간 대시보드 + AI 진단 분석 |
| 코드 작성 능력 부족 | AI 코드생성 (분석형) + AI 키워드 예시 |
